...
export const CONFIG_SPEC: StorageSpec<GameConfig> = {
    ...
    migrate: raw => {
        ...
        return {
            ...
            bloodbathDeathShare: asNum(r.bloodbathDeathShare, DEFAULT_GAME_CONFIG.bloodbathDeathShare),
            arenaDeathShare: asNum(r.arenaDeathShare, DEFAULT_GAME_CONFIG.arenaDeathShare),
