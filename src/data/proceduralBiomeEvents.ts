    ...
    rainforest: [
        {
            ...
            cause: 'Died of jungle fever', dodgeStat: 'endurance', dodgeDifficulty: 7, damage: 22, infected: true, sanity: 12, fatigue: 18,
        ...
        },
        {
            ...
            cause: 'Crushed by a falling giant', dodgeStat: 'agility', damage: 46, bleeding: true, requires: { time: 'night' }, terrains: ['forest'], witnesses: true, zoneWide: true,
        },
        {
            ...
            cause: 'Overrun by army ants', dodgeStat: 'intelligence', sanity: 4, terrains: ['forest', 'wetland', 'open'],
        },
        {
            ...
            cause: 'Overrun by army ants', dodgeStat: 'agility', dodgeDifficulty: 7, damage: 30, infected: true, fatigue: 20, terrains: ['forest', 'wetland', 'open'],
        },
        {
            ...
            cause: 'Poisoned by a drinking vine', dodgeStat: 'intelligence', poisoned: true, damage: 10, terrains: ['forest'], requires: { storm: true },
        },
        {
            ...
            cause: 'Taken by a caiman', dodgeStat: 'agility', damage: 34, bleeding: true, terrains: ['water', 'wetland'],
        },
        {
            ...
            cause: 'Died of trench-foot infection', dodgeStat: 'intelligence', infected: true, fatigue: 12, requires: { storm: true }, terrains: ['wetland', 'forest', 'water'],
        },
        {
            ...
            cause: 'Lost to the canopy', dodgeStat: 'willpower', sanity: 24, requires: { sanityBand: 'frayed' }, terrains: ['forest'],
        },
    ],
    volcanic: [
        {
            ...
            cause: 'Choked on an eruption', dodgeStat: 'intelligence', dodgeDifficulty: 7, damage: 28, burned: true, fatigue: 15, zoneWide: true, witnesses: true, startsZoneEffect: 'burning', terrains: ['open', 'highland', 'forest'],
        },
        {
            ...
            cause: 'Went through the crust', dodgeStat: 'agility', dodgeDifficulty: 7, damage: 50, burned: true, terrains: ['open', 'cave'],
        },
        {
            ...
            cause: 'Buried in a lava tube', dodgeStat: 'intelligence', sanity: 5, special: 'startsQuaking', terrains: ['cave', 'ruins', 'highland'],
        },
        {
            ...
            cause: 'Buried in a lava tube', dodgeStat: 'agility', dodgeDifficulty: 8, damage: 60, special: 'collapse', terrains: ['cave', 'ruins'],
        },
        {
            ...
            cause: 'Scalded by a steam vent', dodgeStat: 'agility', damage: 26, burned: true, terrains: ['water', 'wetland', 'cave'],
        },
        {
            ...
            cause: 'Suffocated in a gas pocket', dodgeStat: 'intelligence', damage: 32, sanity: 8, requires: { time: 'night' }, terrains: ['wetland', 'cave', 'open'],
        },
        {
            ...
            cause: 'Went through the crust', dodgeStat: 'agility', damage: 36, burned: true, requires: { stance: ['Fortified'] }, terrains: ['open', 'highland'],
        },
        {
            ...
            cause: 'Bled out on the glass', dodgeStat: 'agility', damage: 16, bleeding: true, requires: { stance: ['Hunting', 'Aggressive'] }, terrains: ['open'],
        },
    ],
    archipelago: [
        {
            ...
            cause: 'Drowned in the king tide', dodgeStat: 'agility', dodgeDifficulty: 7, damage: 44, zoneWide: true, witnesses: true, startsZoneEffect: 'flooded', terrains: ['water', 'wetland', 'open'],
        },
        {
            ...
            cause: 'Fell from a rope span', dodgeStat: 'strength', damage: 40, bleeding: true, severesRoute: true, terrains: ['highland', 'water'],
        },
        {
            ...
            cause: 'Lost at sea', dodgeStat: 'intelligence', sanity: 6, startsZoneEffect: 'fogbound', terrains: ['water', 'open', 'wetland'],
        },
        {
            ...
            cause: 'Lost at sea', dodgeStat: 'endurance', dodgeDifficulty: 8, damage: 48, fatigue: 30, terrains: ['water'],
        },
        {
            ...
            cause: 'Poisoned by shellfish', dodgeStat: 'intelligence', poisoned: true, damage: 14, feed: 8, terrains: ['water', 'wetland'],
        },
        {
            ...
            cause: 'Blown from the rocks', dodgeStat: 'strength', damage: 30, requires: { storm: true }, terrains: ['highland', 'open'],
        },
        {
        ...
        },
        {
            ...
            cause: 'Killed by a thrown stone', dodgeStat: 'agility', damage: 18, requires: { minSurvivors: 6 }, terrains: ['water', 'open'],
        },
    ],
    highlands: [
        {
            ...
            cause: 'Walked off the ridge in a whiteout', dodgeStat: 'willpower', dodgeDifficulty: 7, damage: 52, requires: { storm: true }, zoneWide: true, terrains: ['highland', 'ice', 'open'],
        },
        {
            ...
            cause: 'Fell through a cornice', dodgeStat: 'intelligence', dodgeDifficulty: 7, damage: 58, terrains: ['highland', 'ice'],
        },
        {
            ...
            cause: 'Buried by an avalanche', dodgeStat: 'intelligence', sanity: 4, terrains: ['highland', 'ice'],
        },
        {
            ...
            cause: 'Buried by an avalanche', dodgeStat: 'agility', dodgeDifficulty: 8, damage: 64, zoneWide: true, witnesses: true, terrains: ['highland', 'ice'],
        },
        {
            ...
            cause: 'Died of altitude sickness', dodgeStat: 'endurance', damage: 18, sanity: 10, fatigue: 16, terrains: ['highland'],
        },
        {
            ...
            cause: 'Fell from a goat path', dodgeStat: 'agility', damage: 34, bleeding: true, terrains: ['highland'],
        },
        {
            ...
            cause: 'Froze on the high ground', dodgeStat: 'endurance', damage: 20, frostbitten: true, requires: { time: 'night' }, terrains: ['highland', 'ice', 'open'],
        },
        {
            ...
            cause: 'Taken by a mountain raptor', dodgeStat: 'agility', damage: 28, bleeding: true, requires: { time: 'day' }, terrains: ['highland', 'open'],
        },
    ],
    tundra: [
        {
            ...
            cause: 'Went through the thawing ice', dodgeStat: 'agility', dodgeDifficulty: 7, damage: 46, frostbitten: true, requires: { time: 'day' }, terrains: ['ice', 'water'],
        },
        {
            ...
            cause: 'Froze in the blizzard', dodgeStat: 'endurance', dodgeDifficulty: 7, damage: 30, frostbitten: true, fatigue: 25, zoneWide: true, startsZoneEffect: 'frozen', requires: { storm: true }, terrains: ['open', 'ice', 'highland'],
        },
        {
            ...
            cause: 'Killed by a white bear', dodgeStat: 'intelligence', sanity: 6, terrains: ['open', 'ice', 'forest'],
        },
        {
        ...
        },
        {
            ...
            cause: 'Died of exposure on the flats', dodgeStat: 'endurance', damage: 16, frostbitten: true, fatigue: 10, terrains: ['open', 'ice'],
        },
        {
            ...
            cause: 'Smothered in a snow drift', dodgeStat: 'agility', damage: 24, fatigue: 22, terrains: ['open', 'ice', 'forest'],
        },
        {
            ...
            cause: 'Wandered off snow-blind', dodgeStat: 'intelligence', sanity: 18, damage: 8, requires: { time: 'day' }, terrains: ['open', 'ice'],
        },
        {
            ...
            cause: 'Froze in hiding', dodgeStat: 'endurance', damage: 22, frostbitten: true, requires: { stance: ['Evasive', 'Shadowing'] }, terrains: ['open', 'ice', 'forest', 'highland'],
        },
    ],
    dunes: [
        {
            ...
            cause: 'Buried by the sandstorm', dodgeStat: 'endurance', dodgeDifficulty: 7, damage: 34, fatigue: 24, thirst: 15, zoneWide: true, witnesses: true, startsZoneEffect: 'fogbound', terrains: ['desert', 'open'],
        },
        {
            ...
            cause: 'Fell down a dry well', dodgeStat: 'intelligence', damage: 44, bleeding: true, quench: 20, terrains: ['desert', 'ruins', 'open'],
        },
        {
            ...
            cause: 'Walked into the deep desert', dodgeStat: 'willpower', thirst: 8, sanity: 5, terrains: ['desert', 'open'],
        },
        {
            ...
            cause: 'Walked into the deep desert', dodgeStat: 'intelligence', dodgeDifficulty: 8, damage: 40, thirst: 30, fatigue: 25, terrains: ['desert', 'open'],
        },
        {
            ...
            cause: 'Died of heatstroke', dodgeStat: 'endurance', damage: 18, burned: true, thirst: 12, requires: { time: 'day' }, terrains: ['desert', 'open'],
        },
        {
            ...
            cause: 'Stung by a desert scorpion', dodgeStat: 'agility', poisoned: true, damage: 12, terrains: ['desert', 'open', 'ruins'],
        },
        {
            ...
            cause: 'Buried by a dune collapse', dodgeStat: 'agility', damage: 28, fatigue: 18, terrains: ['desert'],
        },
        {
            ...
            cause: 'Froze in the desert night', dodgeStat: 'endurance', damage: 16, fatigue: 14, requires: { time: 'night' }, terrains: ['desert', 'open'],
        },
    ],
    bayou: [
        {
            ...
            cause: 'Taken by the old alligator', dodgeStat: 'agility', dodgeDifficulty: 7, damage: 52, bleeding: true, terrains: ['water', 'wetland'],
        },
        {
            ...
            cause: 'Died of the bayou fever', dodgeStat: 'intelligence', infected: true, damage: 18, sanity: 10, requires: { time: 'night' }, terrains: ['wetland', 'water', 'forest'],
        },
        {
            ...
            cause: 'Followed the lights', dodgeStat: 'willpower', sanity: 8, requires: { time: 'night' }, terrains: ['wetland', 'water'],
        },
        {
            ...
            cause: 'Followed the lights', dodgeStat: 'intelligence', dodgeDifficulty: 8, damage: 44, sanity: 20, terrains: ['wetland', 'water'],
        },
        {
            ...
            cause: 'Bled out to leeches', dodgeStat: 'intelligence', bleeding: true, damage: 10, infected: true, terrains: ['wetland', 'water'],
        },
        {
            ...
            cause: 'Bitten by a cottonmouth', dodgeStat: 'agility', poisoned: true, damage: 16, terrains: ['wetland', 'water', 'forest'],
        },
        {
        ...
        },
        {
            ...
            cause: 'Lost to the singing water', dodgeStat: 'willpower', sanity: 26, damage: 10, requires: { sanityBand: 'unravelling' }, terrains: ['water', 'wetland'],
        },
    ],
    ruinlands: [
        {
            ...
            cause: 'Crushed under the tower', dodgeStat: 'agility', dodgeDifficulty: 7, damage: 58, zoneWide: true, witnesses: true, special: 'collapse', terrains: ['ruins', 'urban', 'open'],
        },
        {
            ...
            cause: 'Killed by what was sealed in', dodgeStat: 'intelligence', dodgeDifficulty: 7, damage: 36, poisoned: true, sanity: 12, grantItem: 'medkit', terrains: ['ruins', 'urban'],
        },
        {
            ...
            cause: 'Electrocuted in the old works', dodgeStat: 'intelligence', sanity: 4, terrains: ['ruins', 'urban'],
        },
        {
            ...
            cause: 'Electrocuted in the old works', dodgeStat: 'agility', dodgeDifficulty: 8, damage: 54, burned: true, terrains: ['ruins', 'urban'],
        },
        {
            ...
            cause: 'Fell through a rotten floor', dodgeStat: 'agility', damage: 30, bleeding: true, requires: { elevationOrChoke: true }, terrains: ['ruins', 'urban'],
        },
        {
            ...
            cause: 'Eaten by the rats', dodgeStat: 'willpower', damage: 14, infected: true, sanity: 8, requires: { time: 'night' }, terrains: ['ruins', 'urban'],
        },
        {
            ...
            cause: 'Poisoned by a spoiled cache', dodgeStat: 'intelligence', poisoned: true, damage: 12, feed: 18, terrains: ['ruins', 'urban'],
        },
        {
            ...
            cause: 'Caught in the old city', dodgeStat: 'intelligence', damage: 22, sanity: 10, requires: { trait: 'Strategist' }, terrains: ['ruins', 'urban'],
        },
    ],
    steppe: [
        {
            ...
            cause: 'Burned in a grass fire', dodgeStat: 'intelligence', dodgeDifficulty: 7, damage: 40, burned: true, zoneWide: true, witnesses: true, startsZoneEffect: 'burning', terrains: ['open', 'forest'],
        },
        {
            ...
            cause: 'Trampled by the herd', dodgeStat: 'agility', dodgeDifficulty: 7, damage: 46, bleeding: true, zoneWide: true, terrains: ['open'],
        },
        {
            ...
            cause: 'Ridden down on the steppe', dodgeStat: 'intelligence', sanity: 5, terrains: ['open'],
        },
        {
        ...
        },
        {
            ...
            cause: 'Died of exposure on the steppe', dodgeStat: 'endurance', damage: 14, fatigue: 16, sanity: 8, requires: { storm: true }, terrains: ['open'],
        },
        {
            ...
            cause: 'Broke a leg on the flats', dodgeStat: 'agility', damage: 20, requires: { stance: ['Hunting', 'Aggressive', 'Desperate'] }, terrains: ['open'],
        },
        {
            ...
            cause: 'Struck by lightning', dodgeStat: 'intelligence', damage: 44, burned: true, requires: { storm: true }, terrains: ['open', 'highland'],
        },
        {
            ...
            cause: 'Died of the trampled spring', dodgeStat: 'intelligence', infected: true, damage: 12, quench: 15, terrains: ['water', 'wetland', 'open'],
        },
    ],
    saltmarsh: [
        {
            ...
            cause: 'Drowned in the tide race', dodgeStat: 'intelligence', dodgeDifficulty: 7, damage: 44, zoneWide: true, startsZoneEffect: 'flooded', terrains: ['wetland', 'water'],
        },
        {
            ...
            cause: 'Died of drinking brine', dodgeStat: 'willpower', damage: 24, thirst: 25, sanity: 10, terrains: ['wetland', 'water'],
        },
        {
            ...
            cause: 'Went through the salt crust', dodgeStat: 'intelligence', sanity: 4, terrains: ['wetland', 'open', 'desert'],
        },
        {
            ...
            cause: 'Went through the salt crust', dodgeStat: 'agility', dodgeDifficulty: 8, damage: 48, poisoned: true, terrains: ['wetland', 'open', 'desert'],
        },
        {
            ...
            cause: 'Died of salt-rot', dodgeStat: 'endurance', infected: true, damage: 12, sanity: 6, terrains: ['wetland', 'water', 'open'],
        },
        {
            ...
            cause: 'Killed by nesting marsh-birds', dodgeStat: 'agility', damage: 22, bleeding: true, requires: { time: 'day' }, terrains: ['wetland', 'open'],
        },
        {
            ...
            cause: 'Choked on the salt fog', dodgeStat: 'endurance', damage: 14, fatigue: 12, requires: { time: 'night' }, startsZoneEffect: 'fogbound', terrains: ['wetland', 'water', 'open'],
        },
        {
            ...
            cause: 'Lost to the marsh', dodgeStat: 'willpower', sanity: 22, terrains: ['wetland'],
        },
    ],
    boreal: [
        {
            ...
            cause: 'Crushed by a widowmaker', dodgeStat: 'intelligence', dodgeDifficulty: 7, damage: 50, bleeding: true, requires: { time: 'night' }, zoneWide: true, terrains: ['forest'],
        },
        {
        ...
        },
        {
            ...
            cause: 'Burned in the crown fire', dodgeStat: 'intelligence', sanity: 4, terrains: ['forest', 'highland', 'open'],
        },
        {
            ...
            cause: 'Burned in the crown fire', dodgeStat: 'agility', dodgeDifficulty: 8, damage: 56, burned: true, zoneWide: true, witnesses: true, startsZoneEffect: 'burning', terrains: ['forest'],
        },
        {
            ...
            cause: 'Drowned in the muskeg', dodgeStat: 'agility', damage: 30, frostbitten: true, terrains: ['wetland', 'forest'],
        },
        {
            ...
            cause: 'Killed by a cow moose', dodgeStat: 'agility', damage: 38, bleeding: true, requires: { time: 'day' }, terrains: ['forest', 'wetland'],
        },
        {
            ...
            cause: 'Poisoned by a death-cap', dodgeStat: 'intelligence', poisoned: true, damage: 20, feed: 12, terrains: ['forest'],
        },
        {
            ...
            cause: 'Froze in the taiga', dodgeStat: 'endurance', damage: 22, frostbitten: true, fatigue: 14, requires: { time: 'night' }, terrains: ['forest', 'open', 'wetland'],
        },
    ],
    badlands: [
        {
            ...
            cause: 'Drowned in a dry wash', dodgeStat: 'intelligence', dodgeDifficulty: 7, damage: 46, zoneWide: true, startsZoneEffect: 'flooded', terrains: ['open', 'desert', 'highland'],
        },
        {
            ...
            cause: 'Crushed by a falling hoodoo', dodgeStat: 'agility', dodgeDifficulty: 7, damage: 54, terrains: ['highland', 'open', 'desert'],
        },
        {
            ...
            cause: 'Killed by the thing in the bones', dodgeStat: 'intelligence', sanity: 8, terrains: ['highland', 'open', 'cave'],
        },
        {
            ...
            cause: 'Killed by the thing in the bones', dodgeStat: 'agility', dodgeDifficulty: 8, damage: 60, bleeding: true, terrains: ['highland', 'open', 'cave'],
        },
        {
            ...
            cause: 'Died of heatstroke', dodgeStat: 'endurance', damage: 20, thirst: 14, fatigue: 12, requires: { time: 'day' }, terrains: ['open', 'desert', 'highland'],
        },
        {
            ...
            cause: 'Bitten by a rattlesnake', dodgeStat: 'agility', poisoned: true, damage: 14, terrains: ['highland', 'open', 'desert', 'cave'],
        },
        {
            ...
            cause: 'Drowned in a slot canyon', dodgeStat: 'intelligence', damage: 40, requires: { storm: true }, terrains: ['cave', 'highland'],
        },
        {
            ...
            cause: 'Fell from the clay edge', dodgeStat: 'agility', damage: 32, bleeding: true, requires: { storm: true, stance: ['Hunting', 'Aggressive', 'Desperate'] }, terrains: ['highland', 'open'],
        },
    ],
};
