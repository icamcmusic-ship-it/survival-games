...
export const EXTRA_ARENA_EVENTS_GROUP5: Record<string, ArenaEventDef[]> = {
    labyrinth: [
        {
            ...
            cause: 'Took a turn they had already taken',
        ...
        },
        {
            ...
            cause: 'The hedge closed behind them',
        ...
        },
        {
            ...
            cause: 'Died of thirst inside a green place',
    ...
    nooneplace: [
        {
            ...
            cause: 'Answered to a name that was not theirs',
        ...
        },
        {
            ...
            cause: 'Walked into a room that was not there yesterday',
    ...
    kelvin: [
        ...
        },
        {
            ...
            cause: 'Sealed on the wrong side of a bulkhead',
    ...
    storywood: [
        {
            ...
            cause: 'Given an ending somebody else had written',
            dodgeStat: 'intelligence', dodgeAlt: 'willpower', dodgeDifficulty: 8,
        ...
        },
        {
            ...
            cause: 'Taken by the thing in the second verse',
    ...
    karst: [
        {
            ...
            cause: 'The water table rose while they slept',
            dodgeStat: 'agility', dodgeAlt: 'intelligence', dodgeDifficulty: 8,
        ...
        },
        {
            ...
            cause: 'Went into a passage that only goes one way',
    ...
    vigil: [
        {
            ...
            cause: 'Died standing a watch nobody relieved',
    ...
    frozen: [
        ...
        },
        {
            ...
            cause: 'Died of thirst standing on a continent of ice',
            dodgeStat: 'intelligence', dodgeAlt: 'willpower', dodgeDifficulty: 8,
    ...
    warren: [
        ...
        },
        {
            ...
            cause: 'Died of thirst two tunnels from water',
            dodgeStat: 'intelligence', dodgeAlt: 'endurance', dodgeDifficulty: 7,
    ...
    silkwood: [
        ...
        },
        {
            ...
            cause: 'Died of thirst under a canopy of dew',
            dodgeStat: 'intelligence', dodgeAlt: 'willpower', dodgeDifficulty: 7,
