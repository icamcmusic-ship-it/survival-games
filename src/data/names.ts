...
export const DISTRICT_NAMES: Record<number, Record<Gender, string[]>> = {
    ...
    3: {
        Male: [
            ...
            'Turing', 'Tesler', 'Edison', 'Marconi', 'Faraday', 'Kelvin', 'Hertz', 'Nikola', 'Sturgeon', 'Anod',
            'Bytel', 'Cathon', 'Chipp', 'Codec', 'Cortex', 'Datton', 'Ferrite', 'Gidget', 'Gizmond', 'Induc',
            'Ionic', 'Latch', 'Logus', 'Dynode', 'Micron', 'Modem', 'Ohmes', 'Oscill', 'Pinion', 'Pixel',
            'Plasm', 'Quartzon', 'Raster', 'Rectus', 'Resistor', 'Ripple', 'Router', 'Semicon', 'Sensor', 'Silicus',
            'Socket', 'Sparks', 'Statix', 'Switch', 'Sync', 'Tandem', 'Teslin', 'Toggle', 'Transitor', 'Voltan',
            'Wafer', 'Wattson', 'Wyre', 'Zeno', 'Anten', 'Capaz', 'Chipset', 'Coder', 'Daton', 'Digit',
            'Emitt', 'Filament', 'Gauss', 'Grid', 'Ledger', 'Magnet', 'Neuron', 'Photon', 'Probe', 'Radian',
            'Reboot', 'Signal', 'Solen', 'Static', 'Terminus', 'Vertex', 'Voltaire', 'Weld', 'Widget', 'Rheost',
        ],
        Female: [
            ...
            'Logica', 'Microna', 'Nanette', 'Ohmelia', 'Pixella', 'Quantia', 'Wavelet', 'Anneal', 'Antenna', 'Bytelle',
            'Capacita', 'Chippa', 'Cirra', 'Coila', 'Cursora', 'Diodra', 'Ferrita', 'Filamenta', 'Gadgetta', 'Glitch',
            'Indexia', 'Ionelle', 'Kilowatta', 'Lattice', 'Ampella', 'Magnetta', 'Matrix', 'Neona', 'Voltique', 'Pinna',
            'Polara', 'Query', 'Radia', 'Relaya', 'Resista', 'Schema', 'Sensora', 'Servella', 'Socketta', 'Solura',
            'Statica', 'Synca', 'Tekla', 'Torsion', 'Voltara', 'Wafera', 'Weldia', 'Wyrelle', 'Zetta', 'Soldera',
        ],
    },
    ...
    5: {
        Male: [
            ...
            'Dyno', 'Edison', 'Electron', 'Emberon', 'Farad', 'Flick', 'Fluor', 'Fuller', 'Galvan', 'Generatt',
            'Glower', 'Grid', 'Hydro', 'Ion', 'Kilo', 'Kindle', 'Voltmer', 'Luxon', 'Megger', 'Meter',
            'Neutron', 'Nimbus', 'Outlet', 'Phase', 'Piezo', 'Plug', 'Radian', 'Rayton', 'Rheo', 'Shock',
            'Solar', 'Steam', 'Strobe', 'Tinder', 'Voltan', 'Wattley', 'Wick', 'Zapp', 'Zephyr', 'Rectify',
        ],
        Female: [
            ...
            'Ozona', 'Phasia', 'Photona', 'Piezetta', 'Reactra', 'Rheona', 'Shimmerwatt', 'Sola', 'Sparkes', 'Statica',
            'Surga', 'Tindra', 'Turbina', 'Vatta', 'Voltara', 'Wattsy', 'Wickella', 'Zapria', 'Zella', 'Rectifa',
        ],
    },
    ...
    6: {
        ...
        Female: [
            ...
            'Parkway', 'Skyway', 'Sonic', 'Trolley', 'Voyage', 'Zephyra', 'Aviatrix', 'Coachlin', 'Chevron', 'Coupe',
            ...
            'Axlene', 'Driva', 'Ferrilyn', 'Fleeta', 'Flyte', 'Gantria', 'Glida', 'Harriet', 'Haulie', 'Hubbell',
            'Ignitia', 'Jitney', 'Junctia', 'Locomora', 'Lorrie', 'Macha', 'Pacey', 'Pedala', 'Pinion', 'Pistonia',
            'Ramla', 'Roada', 'Rotora', 'Rounda', 'Semora', 'Signa', 'Spoketta', 'Sprinta', 'Steama', 'Strada',
            'Tarma', 'Terminal', 'Tramway', 'Treadle', 'Trekka', 'Trestla', 'Waybill', 'Wheela', 'Sleepera', 'Cabooseline',
        ],
    },
    ...
    8: {
        ...
        Female: [
            ...
            'Denima', 'Poplina', 'Eyelet', 'Twillen', 'Gossamer', 'Hemmy', 'Jacquarda', 'Knitta', 'Lindsey', 'Lisle',
    ...
    9: {
        Male: [
            ...
            'Leaven', 'Loaf', 'Malt', 'Meal', 'Millard', 'Mow', 'Paddy', 'Reap', 'Rick', 'Rise',
            'Rusk', 'Scythe', 'Seed', 'Semolino', 'Sickle', 'Sorgo', 'Stubble', 'Swath', 'Tassel', 'Windrow',
        ],
        Female: [
            'Grainne', 'Acrelyn', 'Bushelle', 'Chaffina', 'Cerealia', 'Garner', 'Siftella', 'Poppy', 'Ryetta', 'Saffron',
            'Threshel', 'Ceres', 'Autumn', 'Maize', 'Silonne', 'Sesame', 'Honey', 'Wheatley', 'Sierra', 'Sheafling',
            'Griston', 'Cornsilk', 'Demeter', 'Bolter', 'Farina', 'Golden', 'Hearth', 'Oatha', 'Oatlyn', 'Pollen',
            'Quinoa', 'Silage', 'Tillie', 'Wheaten', 'Winnowa', 'Cornflower', 'Levain', 'Oatmeal', 'Ryebelle', 'Semolia',
            'Crumb', 'Thresha', 'Wheatberry', 'Bakewell', 'Chaffron', 'Sunna', 'Marla', 'Fielda', 'Granaria', 'Sheafa',
            ...
            'Farrina', 'Flourette', 'Gleana', 'Graina', 'Ryeling', 'Grista', 'Harvestine', 'Haydee', 'Hominy', 'Kasha',
    ...
    10: {
        ...
        Female: [
            ...
            'Bella', 'Daisy', 'Molly', 'Dolly', 'Bessie', 'Buttercup', 'Heifer', 'Mane', 'Angora', 'Fleecewell',
    ...
    12: {
        ...
        Female: [
            ...
            'Sparrow', 'Speedwell', 'Starling', 'Sylvie', 'Culmen', 'Vetch', 'Wintergreen', 'Woodruff', 'Burdocka', 'Catkin',
            ...
            'Millie', 'Ribbon', 'Sugarlee', 'Taffy', 'Threadgold', 'Anthracia', 'Ashlyn', 'Briquette', 'Colliery', 'Cindra',
            'Coalette', 'Emberly', 'Flinta', 'Galena', 'Graphite', 'Hearth', 'Lignia', 'Anthra', 'Frostwyn', 'Campion',
            'Seam', 'Shalene', 'Slatewyn', 'Sootrose', 'Tallow', 'Veina', 'Wickley', 'Xanthe', 'Lamplight', 'Fireweed',
        ],
    },
    ...
    13: {
        ...
        Female: [
            'Petra', 'Nitra', 'Salvo', 'Cordelia', 'Fuselle', 'Mensura', 'Quill', 'Adamanta', 'Emberline', 'Grisel',
            'Powder', 'Calibra', 'Ordina', 'Cartridge', 'Corva', 'Sulfa', 'Reckoning', 'Pitchara', 'Anvilla', 'Ballist',
            'Muster', 'Argent', 'Volley', 'Lodestone', 'Reserve', 'Cassia', 'Blastine', 'Munitia', 'Detona', 'Salvora',
            'Cramponne', 'Bastia', 'Foundra', 'Redouba', 'Gantrelle', 'Cherta', 'Bitumine', 'Culverta', 'Slagrose', 'Retorta',
            'Fulmina', 'Percussa', 'Locksteppe', 'Rollcalla', 'Musterly', 'Requisa', 'Bulwarka', 'Enfilada', 'Sappera', 'Trenchwyn',
            'Bunkara', 'Siloa', 'Warhelm', 'Fissila', 'Isotopa', 'Reacta', 'Halberda', 'Caissa', 'Limbra', 'Bandolina',
            'Quartermara', 'Kelvya', 'Mareka', 'Dalvina', 'Osrica', 'Rurika', 'Gwenneth', 'Aldousine', 'Tobara', 'Emrysa',
            'Idrisa', 'Brynna', 'Lorca', 'Ewarta', 'Rhyddwen', 'Stanna', 'Corvinna', 'Dravena', 'Aldrica', 'Merricka',
            'Thadda', 'Ellera', 'Cassiana', 'Verra', 'Hollana', 'Stockarda', 'Barricka', 'Kegana', 'Torrina', 'Ansela',
            'Wendella', 'Prycia', 'Lucana', 'Garrica', 'Ormonda', 'Gunnara', 'Roderica', 'Bramwella', 'Fenrica', 'Halvarda',
        ],
    },
    ...
    14: {
        Male: [
            ...
            'Whitlow', 'Boreal', 'Cadge', 'Drayton', 'Firn', 'Glazier', 'Hardtack', 'Isham', 'Jarrow', 'Kelder',
            'Lockram', 'Mordant', 'Nivard', 'Ostend', 'Permafrost', 'Quarrel', 'Ravenal', 'Sablefish', 'Trawler', 'Ullage',
            'Verglas', 'Bitternut', 'Calder', 'Dunmore', 'Ellerby', 'Fenwick', 'Garth', 'Holloway', 'Irving', 'Jessup',
            'Kettleman', 'Lundy', 'Marbeck', 'Norbury', 'Orrick', 'Prentiss', 'Quillon', 'Rothwell', 'Selwyn', 'Tarrant',
        ...
        Female: [
            'Frigore', 'Brinna', 'Rimewyn', 'Icewell', 'Frosta', 'Marlene', 'Cura', 'Winterly', 'Kelvina', 'Ossa',
            'Larderly', 'Solene', 'Brackwyn', 'Coldrose', 'Preserva', 'Icelin', 'Glacine', 'Salterly', 'Hoarfrost', 'Pallas',
            'Crystelle', 'Nivea', 'Chilla', 'Sumpwyn', 'Everfrost', 'Panne', 'Keepsake', 'Glacia', 'Cellara', 'Bitterna',
            'Corninga', 'Icehousel', 'Nitrita', 'Packera', 'Rackarda', 'Saltrama', 'Scupperly', 'Sledgewyn', 'Tundra', 'Vaulta',
            'Whitlowe', 'Yardleigh', 'Borealis', 'Cadgewyn', 'Draytona', 'Firna', 'Glaziera', 'Hardtacka', 'Ishama', 'Jarrowe',
            'Keldra', 'Lockrama', 'Mordanta', 'Nivarda', 'Ostenda', 'Permafrosta', 'Quarrela', 'Ravenella', 'Sablefisher', 'Trawlera',
            'Ullaga', 'Verglasse', 'Windrowe', 'Ashlara', 'Bitternutte', 'Caldera', 'Dunmora', 'Fenwicka', 'Gartha', 'Hollowaye',
            'Irvina', 'Jessupa', 'Kettlewyn', 'Lundya', 'Marbecka', 'Norbura', 'Orricka', 'Prentissa', 'Quillona', 'Rothwella',
            'Selwyna', 'Tarranta', 'Umbra', 'Vandra', 'Westmora', 'Yarrowe', 'Sarnatha', 'Craylle', 'Brackenna', 'Wolda',
            'Hespera', 'Nimbusa', 'Larcha', 'Corbina', 'Sedgewyn', 'Aldousa', 'Brinkleya', 'Cranmera', 'Dunstana', 'Elsworthy',
        ],
    },
    ...
    15: {
        Male: [
            'Kiln', 'Vitrus', 'Cullet', 'Pane', 'Prism', 'Anneal', 'Silex', 'Blowpipe', 'Lehr', 'Frit',
            'Crazing', 'Obsidian', 'Marver', 'Gaffer', 'Punty', 'Slump', 'Fuse', 'Facet', 'Shard', 'Crucible',
            'Batch', 'Temper', 'Lume', 'Clarion', 'Etch', 'Bevel', 'Flux', 'Glint', 'Refract', 'Borosil',
            'Cristal', 'Devitrify', 'Elutriate', 'Feldspar', 'Hearthglass', 'Insulate', 'Jacking', 'Knapp', 'Lampwork', 'Mandrel',
            'Overshot', 'Pontil', 'Quench', 'Rondelet', 'Soda', 'Tessera', 'Undercut', 'Vitrify', 'Wetter', 'Xystos',
            'Zaffre', 'Ashglass', 'Blowhole', 'Dichro', 'Enamel', 'Filigrane', 'Gob', 'Hyaline', 'Incalmo', 'Jalousie',
            'Kilnwright', 'Latticino', 'Millefior', 'Nipt', 'Opalesce', 'Pyrex', 'Reticello', 'Sagger', 'Threadwork', 'Ultramar',
            'Vetro', 'Whetglass', 'Xanth', 'Zircar', 'Drossel', 'Emberglass', 'Flamework', 'Grozing', 'Halloway', 'Ignis',
            'Kicking', 'Lehrmaster', 'Murrine', 'Nithe', 'Panel', 'Quilling', 'Rakestraw', 'Sandcast', 'Tinctor', 'Ventwyn',
            'Wheelcut', 'Aventurine', 'Bullseye', 'Chalcedon', 'Craquelure', 'Dalle', 'Embossel', 'Flashing', 'Gaffrey', 'Hobnail',
        ],
        Female: [
            'Vitra', 'Prisma', 'Clarity', 'Lumen', 'Silica', 'Annealla', 'Shardis', 'Facette', 'Crazia', 'Cullette',
            'Marvella', 'Vitrine', 'Lustra', 'Fritte', 'Obsidia', 'Bevelle', 'Temperance', 'Glinta', 'Cristallo', 'Etcha',
            'Refracta', 'Slumpwyn', 'Annealer', 'Sablewyn', 'Fusia', 'Batchel', 'Lehrwyn', 'Opaline', 'Verre', 'Sheen',
            'Borosila', 'Cristalle', 'Devitra', 'Elutria', 'Feldspara', 'Gathera', 'Hearthglassa', 'Insula', 'Jackina', 'Knappa',
            'Lampwyn', 'Mandrella', 'Nuclea', 'Overshotte', 'Pontilla', 'Quenchia', 'Rondella', 'Sodalis', 'Tesserae', 'Undercutte',
            'Vitrifa', 'Wettera', 'Xysta', 'Yolande', 'Zaffra', 'Ashglassa', 'Blowholla', 'Chevrona', 'Dichroa', 'Enamella',
            'Filigrana', 'Gobelle', 'Hyalina', 'Incalma', 'Jalousa', 'Kilnwrighta', 'Latticina', 'Millefiora', 'Nipta', 'Opalessa',
            'Pyra', 'Reticella', 'Saggera', 'Threadwyn', 'Ultramara', 'Vetra', 'Whetglassa', 'Xantha', 'Zircara', 'Drossella',
            'Emberglassa', 'Flamewyn', 'Grozia', 'Hallowa', 'Ignisa', 'Jarrowa', 'Kickina', 'Lehrmistra', 'Murrina', 'Nitha',
            'Panella', 'Quilla', 'Rakestrawe', 'Sandcasta', 'Tinctora', 'Ventwyna', 'Wheelcutte', 'Aventurina', 'Bullseya', 'Chalcedona',
        ],
    },
    ...
    16: {
        Male: [
            ...
            'Trencher', 'Turnbuckle', 'Wellhead', 'Winchell', 'Careen', 'Escarp', 'Founder', 'Hogsback', 'Innes', 'Knotwell',
            'Moorsman', 'Norder', 'Oarlock', 'Pilotman', 'Quadrant', 'Rodwell', 'Seaborne', 'Ulster', 'Veerly', 'Waterman',
            'Yardarm', 'Ziggurat', 'Brimmer', 'Currach', 'Dowsett', 'Fendall', 'Grimsby', 'Holdfast', 'Amberjack', 'Brailsford',
        ...
        Female: [
            ...
            'Halyarda', 'Jackupa', 'Kellyn', 'Leadlina', 'Mudlina', 'Nettla', 'Outboarda', 'Pennanta', 'Quaylle', 'Reeva',
            'Roughnecka', 'Scarpa', 'Semisuba', 'Sheava', 'Slipwaya', 'Sonara', 'Spudcana', 'Steevera', 'Stopcocka', 'Swivella',
            'Thwarta', 'Topsida', 'Tourella', 'Traversa', 'Trenchera', 'Turnbuckla', 'Wellheada', 'Winchella', 'Yawla', 'Bosuna',
            'Careena', 'Dredgia', 'Escarpa', 'Gunwala', 'Hogsbacka', 'Innessa', 'Jetsamme', 'Knotwella', 'Lanyarda', 'Moorsa',
            'Nordera', 'Oarlocka', 'Pilota', 'Quadranta', 'Rodwella', 'Seaborna', 'Tacklia', 'Ulstera', 'Waterwyn', 'Yardarma',
            'Zigurra', 'Brimmera', 'Dowsetta', 'Fendalla', 'Grimsa', 'Holdfasta', 'Amberjacka', 'Brailsforda', 'Cardwella', 'Deadrisa',
        ],
    },
};
