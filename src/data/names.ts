...
export const DISTRICT_NAMES: Record<number, Record<Gender, string[]>> = {
    ...
    4: {
        ...
        Female: [
            ...
            'Cascabel', 'Clam', 'Cowrie', 'Current', 'Darya', 'Drift', 'Finna', 'Galatea', 'Gullwing', 'Harbor',
    ...
    12: {
        ...
        Female: [
            ...
            'Coalette', 'Emberly', 'Flinta', 'Galena', 'Graphite', 'Hearth', 'Lignia', 'Mica', 'Frostwyn', 'Campion',
    ...
    13: {
        ...
        Female: [
            ...
            'Powder', 'Calibra', 'Ordina', 'Tallis', 'Corva', 'Sulfa', 'Reckoning', 'Pitchara', 'Anvilla', 'Struck',
    ...
    14: {
        ...
        Female: [
            'Saline', 'Brinna', 'Rimewyn', 'Halite', 'Frosta', 'Marlene', 'Cura', 'Winterly', 'Kelvina', 'Ossa',
            'Larderly', 'Solene', 'Brackwyn', 'Coldrose', 'Preserva', 'Icelin', 'Cask', 'Salterly', 'Hoarfrost', 'Pallas',
    ...
    15: {
        ...
        Female: [
            ...
            'Marvella', 'Pane', 'Lustra', 'Fritte', 'Obsidia', 'Bevelle', 'Temperance', 'Glinta', 'Crucible', 'Etcha',
            'Refracta', 'Slumpwyn', 'Clarion', 'Sablewyn', 'Fusia', 'Batchel', 'Lehrwyn', 'Opaline', 'Verre', 'Sheen',
    ...
    16: {
        ...
        Female: [
            'Fathoma', 'Marina', 'Nerissa', 'Riserly', 'Bathya', 'Undertow', 'Corrie', 'Sirena', 'Plumbline', 'Anchora',
            'Trawla', 'Kelpie', 'Hawsell', 'Cleatwyn', 'Nadira', 'Shoala', 'Cordelle', 'Bilgewyn', 'Keelin', 'Marlena',
            'Windlassa', 'Tillera', 'Brackish', 'Abyssa', 'Sounder', 'Derricka', 'Pelagia', 'Grapnelle', 'Deepwyn', 'Abyssala',
