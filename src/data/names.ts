...
export const DISTRICT_NAMES: Record<number, Record<Gender, string[]>> = {
    ...
    1: {
        Male: [
            'Marvel', 'Gloss', 'Cashmere', 'Velvet', 'Suede', 'Jewel', 'Sterling', 'Lux', 'Prince', 'Royal',
            'Onyx', 'Jasper', 'Garnet', 'Zircon', 'Topaz', 'Quartz', 'Cobalt', 'Flint', 'Slate', 'Argent',
            'Aurelius', 'Augustus', 'Baron', 'Marquis', 'Duke', 'Regis', 'Cassio', 'Dorian', 'Valentin', 'Lucian',
            'Bullion', 'Carat', 'Facet', 'Filigree', 'Ingot', 'Lapis', 'Halo', 'Scepter', 'Solitaire', 'Splendor',
            'Tourmaline', 'Trinket', 'Brocade', 'Coronet', 'Aurum', 'Baroque', 'Bezel', 'Cabochon', 'Ermine', 'Gilt',
            'Karat', 'Medallion', 'Mink', 'Ormolu', 'Regal', 'Vermeil', 'Chalice', 'Ducat', 'Finial', 'Gild',
            'Guilder', 'Monocle', 'Plinth', 'Rondel', 'Sovereign', 'Tinsel', 'Crest', 'Dandy', 'Damask', 'Sheen',
            'Glint', 'Luster', 'Polish', 'Emerald', 'Beryl', 'Rhodium', 'Platinum', 'Obsidian', 'Carnelian', 'Peridot',
            'Aurelian', 'Cashton', 'Gleam', 'Opaline', 'Silvano', 'Goldwin', 'Gemson', 'Lazule', 'Satine', 'Velour',
            'Adorno', 'Bijan', 'Crispin', 'Eston', 'Florian', 'Jareth', 'Luxor', 'Orian', 'Percival', 'Sterlyn',
        ],
        Female: [
            'Glimmer', 'Crystal', 'Diamond', 'Opal', 'Sapphire', 'Silk', 'Lace', 'Amber', 'Pearl', 'Ruby',
            'Jade', 'Ivory', 'Tiara', 'Shimmer', 'Glitter', 'Satin', 'Bijou', 'Sparkle', 'Sequin', 'Gilda',
            'Aurelia', 'Beryl', 'Cameo', 'Charm', 'Duchess', 'Marquise', 'Opaline', 'Pendant', 'Peridot', 'Prism',
            'Regalia', 'Tulle', 'Velour', 'Zirconia', 'Brilliance', 'Gemma', 'Iolite', 'Lucent', 'Mirabelle', 'Nacre',
            ...
            'Aurora', 'Bijoux', 'Coronet', 'Estelle', 'Gloriana', 'Lucia', 'Odalys', 'Priscilla', 'Solange', 'Valencia',
        ],
    },
    ...
    2: {
        Male: [
            ...
            'Keystone', 'Legion', 'Marble', 'Mason', 'Obelisk', 'Praetor', 'Quarry', 'Rampart', 'Slate', 'Turret',
            'Vulcan', 'Warden', 'Centurion', 'Cobble', 'Lintel', 'Mortar', 'Sentinel', 'Sledge', 'Vigil', 'Ashlar',
        ...
        Female: [
            ...
            'Aurora', 'Sentina', 'Bellira', 'Castella', 'Ferra', 'Gradia', 'Petronia', 'Pillara', 'Rampara', 'Turria',
    ...
    3: {
        Male: [
            ...
            'Induc', 'Ionic', 'Latch', 'Logus', 'Lumen', 'Micron', 'Modem', 'Ohmes', 'Oscill', 'Pinion',
        ...
        Female: [
            ...
            'Alpha', 'Delta', 'Sigma', 'Zeta', 'Hexa', 'Kilo', 'Nano', 'Octa', 'Quanta', 'Vectra',
            ...
            'Glitch', 'Indexia', 'Ionelle', 'Kilowatta', 'Lattice', 'Lumen', 'Magnetta', 'Matrix', 'Neona', 'Nixie',
    ...
    4: {
        Male: [
            ...
            'Ketch', 'Kraken', 'Mako', 'Moray', 'Nettle', 'Oar', 'Pelagius', 'Prow', 'Sailor', 'Scale',
            'Seaton', 'Sinker', 'Skiff', 'Sloop', 'Squall', 'Swells', 'Tiller', 'Trawl', 'Wake', 'Weir',
        ],
        Female: [
            ...
            'Shell', 'Sela', 'Coralie', 'Perla', 'Moana', 'Halcyon', 'Amphitrite', 'Bay', 'Beryl', 'Brisa',
    ...
    5: {
        Male: [
            ...
            'Faraday', 'Tesler', 'Kelvinor', 'Voltaire', 'Wattson', 'Ohmar', 'Joules', 'Ampton', 'Sparrow', 'Ray',
            ...
            'Ignitor', 'Lambent', 'Ember', 'Cinder', 'Beam', 'Blaze', 'Charger', 'Circuit', 'Corona', 'Crackle',
            'Dyno', 'Edison', 'Electron', 'Emberon', 'Farad', 'Flick', 'Fluor', 'Fuller', 'Fuse', 'Galvan',
            'Generatt', 'Glower', 'Grid', 'Hydro', 'Ion', 'Kilo', 'Kindle', 'Lumen', 'Luxon', 'Megger',
        ...
        Female: [
            ...
            'Amperia', 'Corona', 'Ember', 'Ionia', 'Joulene', 'Lumen', 'Neon', 'Plasma', 'Pulse', 'Radiance',
            ...
            'Ray', 'Gleama', 'Glow', 'Halo', 'Kindra', 'Wattine', 'Fluxelle', 'Ignita', 'Hydrona', 'Cascadia',
            'Amber', 'Beama', 'Brighte', 'Chispa', 'Cindra', 'Coilette', 'Currenta', 'Dyna', 'Edisa', 'Emberly',
            'Energa', 'Farada', 'Filamenta', 'Flicker', 'Fluorine', 'Fresna', 'Fusia', 'Galvana', 'Gamma', 'Glinta',
            'Gridelle', 'Heliona', 'Ionelle', 'Jolt', 'Kilowatts', 'Lampyra', 'Luxa', 'Magnetta', 'Meterly', 'Nixie',
    ...
    6: {
        ...
        Female: [
            ...
            'Avia', 'Axela', 'Boulevard', 'Caravan', 'Chrome', 'Cyclone', 'Delta', 'Gearette', 'Jetta', 'Mileva',
            ...
            'Journey', 'Wanda', 'Marta', 'Carrie', 'Vela', 'Rhoda', 'Portia', 'Wren', 'Swift', 'Breeze',
            'Amelia', 'Beryl', 'Bessie', 'Cabrey', 'Camina', 'Charabelle', 'Cinder', 'Coasta', 'Compass', 'Derailla',
    ...
    7: {
        Male: [
            ...
            'Aspen', 'Burl', 'Conifer', 'Dogwood', 'Ebony', 'Grain', 'Hatchet', 'Hew', 'Juniper', 'Laurel',
            'Linden', 'Lodgepole', 'Moss', 'Mulch', 'Needle', 'Pitch', 'Root', 'Rowan', 'Sylvan', 'Tamarack',
            'Timberlake', 'Torch', 'Trunk', 'Understory', 'Wedge', 'Willows', 'Woody', 'Wren', 'Yoke', 'Sorrel',
        ],
        Female: [
            'Johanna', 'Pine', 'Willow', 'Birch', 'Maple', 'Hazel', 'Flora', 'Fern', 'Leaf', 'Branch',
            'Clover', 'Ivy', 'Sylvan', 'Amber', 'Aspen', 'Sequoia', 'Holly', 'Bloom', 'Autumn', 'Blossom',
            'Juniper', 'Acacia', 'Alder', 'Arbor', 'Bramble', 'Briar', 'Camellia', 'Canopy', 'Dryad', 'Elmira',
            'Grove', 'Hollow', 'Laurel', 'Linden', 'Magnolia', 'Myrtle', 'Olive', 'Rowan', 'Sapling', 'Sorrel',
            ...
            'Lignia', 'Mossy', 'Oakleigh', 'Piney', 'Poplar', 'Sappho', 'Sawyer', 'Sprucia', 'Sylvie', 'Tansy',
    ...
    8: {
        Male: [
            ...
            'Flax', 'Fiber', 'Needle', 'Shear', 'Nylon', 'Corduroy', 'Tweed', 'Velvet', 'Silk', 'Twill',
        ...
        Female: [
            'Cecelia', 'Paylor', 'Satin', 'Velvet', 'Thread', 'Lace', 'Paisley', 'Silk', 'Chiffon', 'Taffeta',
            ...
            'Chintz', 'Dobby', 'Faille', 'Flannel', 'Gauze', 'Hemline', 'Madras', 'Shantung', 'Twillia', 'Cotton',
            'Twyla', 'Tayla', 'Seamly', 'Dyanne', 'Pearl', 'Rosette', 'Frill', 'Tassel', 'Velva', 'Woolsey',
            ...
            'Shears', 'Silka', 'Spoolie', 'Swatcha', 'Tafeta', 'Textilia', 'Tricot', 'Weftly', 'Wefta', 'Yarrow',
        ],
    },
    ...
    9: {
        Male: [
            ...
            'Farro', 'Flail', 'Flour', 'Gluten', 'Grange', 'Groat', 'Harvest', 'Hay', 'Kamut', 'Knead',
            'Leaven', 'Loaf', 'Malt', 'Meal', 'Millet', 'Mow', 'Paddy', 'Reap', 'Rick', 'Rise',
            'Rusk', 'Scythe', 'Seed', 'Semolino', 'Sickle', 'Sorgo', 'Stubble', 'Swath', 'Tassel', 'Windrow',
        ],
        Female: [
            'Amber', 'Meadow', 'Grain', 'Blossom', 'Cerealia', 'Harvest', 'Clover', 'Poppy', 'Flora', 'Saffron',
            'Barley', 'Ceres', 'Autumn', 'Maize', 'Rye', 'Sesame', 'Honey', 'Wheatley', 'Sierra', 'Millet',
            ...
            'Bria', 'Wren', 'Lark', 'Dawn', 'June', 'Aurelia', 'Blythe', 'Fern', 'Hazel', 'Laurel',
    ...
    10: {
        Male: [
            ...
            'Bay', 'Bellow', 'Bison', 'Brander', 'Bull', 'Butcher', 'Cattle', 'Chap', 'Cowl', 'Dairy',
            'Dobbin', 'Fodder', 'Gaucho', 'Graze', 'Herd', 'Hereford', 'Hide', 'Hitch', 'Mutton', 'Ox',
            'Piebald', 'Ram', 'Roper', 'Rowdy', 'Shear', 'Sorrel', 'Stock', 'Tether', 'Trough', 'Wool',
        ],
        Female: [
            ...
            'Brindle', 'Cinnamon', 'Creamery', 'Dapple', 'Ewelyn', 'Grazia', 'Holstein', 'Jersey', 'Lariat', 'Marigold',
            ...
            'Annie', 'Belle', 'Birdie', 'Cassidy', 'Georgia', 'Hattie', 'June', 'Loretta', 'Opal', 'Reba',
            'Bandana', 'Bay', 'Blaze', 'Bonnet', 'Bramble', 'Calfa', 'Chapparal', 'Cowslip', 'Cream', 'Dun',
    ...
    11: {
        Male: [
            'Thresh', 'Chaff', 'Reap', 'Clay', 'Root', 'Sprout', 'Arbor', 'Seed', 'Harvest', 'Clover',
            ...
            'Yam', 'Sorrel', 'Husk', 'Chicory', 'Cider', 'Dill', 'Fennel', 'Gourd', 'Kale', 'Milo',
            ...
            'Barrow', 'Bean', 'Berry', 'Bloom', 'Bud', 'Burr', 'Cotton', 'Cress', 'Damson', 'Fig',
            'Flax', 'Gather', 'Glean', 'Hay', 'Lentil', 'Marrow', 'Melon', 'Peach', 'Pip', 'Pomme',
            'Quince', 'Rake', 'Rush', 'Sage', 'Sap', 'Shuck', 'Sow', 'Sugar', 'Tiller', 'Yarrow',
        ],
        Female: [
            'Rue', 'Seeder', 'Blossom', 'Daisy', 'Holly', 'Lily', 'Rose', 'Petal', 'Flora', 'Rosemary',
            'Lavender', 'Poppy', 'Cherry', 'Peach', 'Berry', 'Clover', 'Olive', 'Marigold', 'Jasmine', 'Fern',
            'Apricot', 'Basil', 'Calla', 'Camellia', 'Dahlia', 'Fig', 'Ginger', 'Hyacinth', 'Juniper', 'Mulberry',
            ...
            'Nettle', 'Peppermint', 'Pomegranate', 'Rhubarb', 'Tamarind', 'Wisteria', 'Meadowlark', 'Harvestine', 'Orchid', 'Vinelle',
            ...
            'Hazel', 'Magnolia', 'Melba', 'Okrah', 'Pearblossom', 'Primula', 'Sylvie', 'Tulip', 'Vervain', 'Violet',
        ],
    },
    ...
    12: {
        Male: [
            'Gale', 'Haymitch', 'Burdock', 'Ash', 'Flint', 'Dust', 'Slate', 'Stone', 'Coal', 'Ore',
            'Soot', 'Pebble', 'Cinder', 'Ember', 'Gravel', 'Grit', 'Lantern', 'Lode', 'Mica', 'Pitch',
            ...
            'Heron', 'Hollow', 'Hunter', 'Jay', 'Lark', 'Moss', 'Ridge', 'River', 'Sedge', 'Snare',
            'Sumac', 'Tam', 'Teasel', 'Thorn', 'Wilder', 'Wolf', 'Yew', 'Alder', 'Birchen', 'Bracken',
            'Peeta', 'Rye', 'Bannock', 'Barm', 'Cobbler', 'Crumb', 'Farl', 'Grady', 'Griddle', 'Loaven',
            'Malt', 'Miller', 'Oren', 'Rounds', 'Rusk', 'Sorrel', 'Tanner', 'Toby', 'Wick', 'Yeaston',
            'Adit', 'Bellows', 'Canary', 'Chert', 'Coke', 'Delve', 'Galen', 'Hewitt', 'Marl', 'Onyx',
            'Pick', 'Quarrier', 'Seamus', 'Shaft', 'Sledge', 'Smelt', 'Spade', 'Tinder', 'Winch', 'Zinc',
        ],
        Female: [
            'Katniss', 'Primrose', 'Maysilee', 'Ember', 'Cinder', 'Hazel', 'Iris', 'Violet', 'Willow', 'Rue',
            'Aster', 'Bryony', 'Chicory', 'Fern', 'Heather', 'Ivy', 'Juniper', 'Laurel', 'Mallow', 'Meadow',
            'Nettle', 'Raven', 'Sage', 'Sorrel', 'Tansy', 'Thistle', 'Wren', 'Yarrow', 'Clover', 'Dove',
            'Fennel', 'Filly', 'Ginger', 'Hyssop', 'Lark', 'Linnet', 'Mim', 'Posy', 'Robin', 'Senna',
            'Sparrow', 'Speedwell', 'Starling', 'Sylvie', 'Teasel', 'Vetch', 'Wintergreen', 'Woodruff', 'Burdocka', 'Catkin',
            'Madge', 'Delly', 'Rooba', 'Daisy', 'Marigold', 'Pansy', 'Peony', 'Rosanna', 'Sweetbriar', 'Tulip',
            ...
            'Coalette', 'Emberly', 'Flinta', 'Galena', 'Graphite', 'Hearth', 'Lignia', 'Mica', 'Obsidia', 'Opal',
            'Pearl', 'Seam', 'Shalene', 'Slatewyn', 'Sootrose', 'Tallow', 'Veina', 'Wickley', 'Xanthe', 'Lamplight',
        ],
    },
};
